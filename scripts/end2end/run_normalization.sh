...
python run_fuzzy_inference.py --config ../../configs/end2end/config_study_cortico_v1.cfg
...
python run_embedding_similarity.py --config ../../configs/end2end/config_study_cortico_v1.cfg
