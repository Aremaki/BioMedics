...
class BratConnector(object):
    ...
    def brat2docs(self, nlp: Language, run_pipe=False) -> List[Doc]:
        ...
        for doc, doc_annotations in tqdm(
            ...
            for ent in doc_annotations["entities"]:
                ...
                if ent["comments"]:
                    if not Span.has_extension("comments"):
                        Span.set_extension("comments", default=None)
                ...
                for fragment in ent["fragments"]:
                    ...
                    for comment in ent["comments"]:
                        span._.set("comments", comment["comment"])
                    spans.append(span)
    ...
    def docs2brat(self, docs: List[Doc]) -> None:
        ...
        for doc in tqdm(docs, total=len(docs)):
            self.doc2brat(doc)
        print(f"Converted {len(docs)} docs into brat")
